...
import gitolite.manager.git.GitManager;
import gitolite.manager.git.JGitManager;
...
public class ConfigManager {
	...
	private void ensureAdminRepoIsUpToDate() throws ServiceUnavailable, GitException, IOException {
